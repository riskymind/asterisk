      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">Zuri Health • 2021 - Present</p>
          ...
          >
            ...
            <p className="text-primary mb-2">Decagon Institute • 2018 - 2021</p>
            <ul className="text-secondary list-disc list-inside space-y-2">
      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">Imo State University • 2008 - 2012</p>
